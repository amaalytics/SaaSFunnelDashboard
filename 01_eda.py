...
import pandas as pd
import sys
sys.stdout.reconfigure(encoding='utf-8') #to force the characters which is the arrow [→]
...
print("\n" + "=" * 60)
print("LEAD SOURCES — WHICH ONE BRINGS THE MOST?")
print("=" * 60)
print(f"\n{df['lead_source'].value_counts().to_string()}")

# ── 6. Quick cross-tab: source × stage ──
print("\n" + "=" * 60)
